...
----------------------------------------------
 Author    : KING SOJIB
 Github    : K1NG-SOJIB-69
 Facebook  : NOBITA
 Tool Name : KING-PRO
 Type type : PAID
 Version   : 0.0.1
----------------------------------------------
 KING Pro version 0.0.1
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://wa.me/+8801879614819/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://github.com/K1NG-SOJIB-69');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://youtube.com/@schoff3605');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi SOJIB Sir, I Need To Buy Your Paid KING PRO Tools Version 0.0.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
